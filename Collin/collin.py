# GOALS FOR THIS FILE
# HAVE CLASS EASILY CALLED AS BEACON
# HAVE CLASS EASILY CALLED AS SCANNER
# Very similar to pi_pact.py
...
class Scanner(object):
    ...
    def scanOnce(self, revisit=1):
        ...
        self.__logger.info(f"Starting beacon scanner (once).")
        timestamp = datetime.now()
        scan = (self.__service.scan(revisit))
        self.__logger.info("Stopping beacon scanner (once).")
